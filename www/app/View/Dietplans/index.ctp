...
<head>
  ...
  <?php
	...
	echo $this->Html->css('jchartfx.css');
	...
	echo $this->Html->script('foundation/foundation.js');
  	...
  	echo $this->Html->script('jchartfx/jchartfx.system.js');
  	echo $this->Html->script('jchartfx/jchartfx.coreVector.js');
  	echo $this->Html->script('jchartfx/jchartfx.advanced.js');
